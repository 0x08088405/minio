...
pub trait ReadPrimitives: io::Read {
    ...
    read_impl!(i8, "an `i8`", read_i8_le, read_i8_be, read_i8_ne);
    read_impl!(u8, "a `u8`", read_u8_le, read_u8_be, read_u8_ne);
    read_impl!(i16, "an `i16`", read_i16_le, read_i16_be, read_i16_ne);
    read_impl!(u16, "a `u16`", read_u16_le, read_u16_be, read_u16_ne);
    read_impl!(i32, "an `i32`", read_i32_le, read_i32_be, read_i32_ne);
    read_impl!(u32, "a `u32`", read_u32_le, read_u32_be, read_u32_ne);
    read_impl!(i64, "an `i64`", read_i64_le, read_i64_be, read_i64_ne);
